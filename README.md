# software_openjdk-8-jre-headless
=========

This role will install openjdk-8-jre-headless software
...
--------------------
    ...
    ---
    - src: git@github.com:xussof/software_openjdk-8-jre-headless
      scm: git
      version: master
      name: software_openjdk-8-jre-headless
